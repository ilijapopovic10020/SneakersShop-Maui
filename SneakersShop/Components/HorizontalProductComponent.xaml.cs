...
public partial class HorizontalProductComponent : ContentView
{
    public static readonly BindableProperty ImageProperty =
        BindableProperty.Create(nameof(Image), typeof(string), typeof(HorizontalProductComponent), "");

    public static readonly BindableProperty NameProperty =
        BindableProperty.Create(nameof(Name), typeof(string), typeof(HorizontalProductComponent), "");

    public static readonly BindableProperty BrandProperty =
        BindableProperty.Create(nameof(Brand), typeof(string), typeof(HorizontalProductComponent), "");

    public static readonly BindableProperty PriceProperty =
        BindableProperty.Create(nameof(Price), typeof(string), typeof(HorizontalProductComponent), "");

    public static readonly BindableProperty AvgStarsProperty =
        BindableProperty.Create(nameof(AvgStars), typeof(string), typeof(HorizontalProductComponent), "");

    public static readonly BindableProperty ReviewsCountProperty =
        BindableProperty.Create(nameof(ReviewsCount), typeof(string), typeof(HorizontalProductComponent), "");

    public static readonly BindableProperty ProductIdProperty =
        BindableProperty.Create(nameof(ProductId), typeof(int), typeof(HorizontalProductComponent), 0);
    ...
    public HorizontalProductComponent()
	{
		InitializeComponent();
	}
